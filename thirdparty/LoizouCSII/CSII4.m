function [CSIIh,CSIIm,CSIIl]= CSII4(name_ref,name_enh,Srate1)
%-------------------------------------------------------------
% 
% Reference:
...
% end
 ...
 [data1, ~, ~] = wavread(name_ref);
 [data2, ~, ~] = wavread(name_enh);
...
%     0.0555
%     0.0493];
[BAND,bw] = audspace(150,fs/2,17,'bark');
bandwidth=(BAND(2:end)-BAND(1:end-1));
[cent_freq,Weight]=get_ANSIs(BAND(1:end-1));
% ----------------------------------------------------------------------
