...
classdef rt_chorus< rt_manipulator
    ...
    methods
        ...
        function obj=rt_chorus(parent,varargin)
            ...
            add(obj.p,param_float_slider('Depth1',pars.Results.Depth1,'minvalue',0, 'maxvalue',10));
            add(obj.p,param_float_slider('Rate1',pars.Results.Rate1,'minvalue',0, 'maxvalue',10));
            add(obj.p,param_float_slider('Depth2',pars.Results.Depth2,'minvalue',0, 'maxvalue',10));
            ...
            s='Chorus is wrapper of Matlab function audioexample.';
        ...
        function sr=apply(obj,s)
            if has_changed(obj.p)
                obj.mychorus.Delay =getvalue(obj.p,'Delay');
                obj.mychorus.Rate=[getvalue(obj.p,'Rate1') getvalue(obj.p,'Rate2') ];
                obj.mychorus.Depth=[getvalue(obj.p,'Depth1') getvalue(obj.p,'Depth2') ];
                obj.mychorus.WetDryMix=getvalue(obj.p,'WetDryMix');
                set_changed_status(obj.p,0);
            end
            sr=obj.mychorus(s);
        end
