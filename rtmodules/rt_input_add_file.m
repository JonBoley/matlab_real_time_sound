...
classdef rt_input_add_file < rt_input
    properties
        attenuation;
        recorder;
        fileFs;
...
%   Copyright 2019 Stefan Bleeck, University of Southampton
    methods
        function obj=rt_input_add_file(parent,varargin) %% called the very first time around
        ...
        function post_init(obj) % called the second times around
            ...
            obj.recorder= dsp.AudioFileReader(getvalue(obj.p,'filename'),'PlayCount',1,'SamplesPerFrame',obj.file_frame_length);
            cd(od);
        end
