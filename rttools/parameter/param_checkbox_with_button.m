...
classdef param_checkbox_with_button < param_checkbox & param_button
    methods (Access = public)
        function param=param_checkbox_with_button(text,val,varargin)
        ...
        function draw(param,parentpanel,x,y)
            draw@param_checkbox(param,parentpanel,x,y);
        ...
        function disp(param)
            fprintf('%s (checkbox with button): %d\n',param.text,param.value);
        end
